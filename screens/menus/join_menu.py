...
class JoinMenuScreen(MenuScreen):
    def __init__(self, screen, clock, options):
        ...
        self.texts += [TextBox(text="ПРИСОЕДИНИТЬСЯ", **self.title_params)]
        B_Y, B_GAP = 250, 150
        ...
        self.join_button = Button(x=300, text="ПРИСОЕДИНИТЬСЯ", **buttons_params)
        self.back_button = Button(x=1280 - 600, text="НАЗАД", **buttons_params)
